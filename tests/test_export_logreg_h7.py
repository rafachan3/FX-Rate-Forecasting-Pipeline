...
def test_export_model():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        df_feat.loc[df_feat.index[0], "direction_7d"] = 0
        df_feat.loc[df_feat.index[1], "direction_7d"] = 1
...
def test_export_model_dry_run():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Ensure at least 2 classes so model fitting doesn't crash even in dry_run
        df_feat.loc[df_feat.index[0], "direction_7d"] = 0
        df_feat.loc[df_feat.index[1], "direction_7d"] = 1
